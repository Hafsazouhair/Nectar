<template>
<footer class="bg-gray-800 py-8 px-8 font-[sans-serif] tracking-wide mt-16">
      <div class="relative">
        <div class="bg-blue-600 gap-3 rounded-md flex items-center sm:px-12 max-sm:px-4 py-4 absolute top-[-66px] w-full">
          <h6 class="text-white sm:text-xl max-sm:text-sm font-semibold">Kickstart Your Career Today</h6>
          <button type='button'
            class="sm:px-4 max-sm:px-2 py-2 sm:text-sm max-sm:text-xs rounded-full text-blue-600 gap-2 bg-white ml-auto">Get
            Started</button>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
          <div>
            <h4 class="text-xl font-semibold mb-6 text-white">About Us</h4>
            <p class="text-gray-400 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Web
                Development</a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Mobile App
                Development</a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">UI/UX
                Design</a></li>
              <li><a href="javascript:void(0)" class="text-gray-400 hover:text-gray-300 text-base">Digital
                Marketing</a></li>
            </ul>
          </div>

          <div>
            <h4 class="text-xl font-semibold mb-6 text-white">Contact Us</h4>
            <ul class="space-y-4">
              <li class="text-gray-400 text-base">123 Main Street</li>
              <li class="text-gray-400 text-base">City, State, Country</li>
              <li class="text-gray-400 text-base">contact@example.com</li>
              <li class="text-gray-400 text-base">+1 234 567 890</li>
            </ul>
          </div>

          <div>
            <h4 class="text-xl font-semibold mb-6 text-white">Follow Us</h4>
      ...
      <div class="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
        <p class='text-gray-400 text-base'>© ReadymadeUI. All rights reserved.</p>
      </div>
    </footer>
